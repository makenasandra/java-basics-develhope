...
public class Main {
    ...
    private static void exercise1() {
        ...
        System.out.println("String in Uppercase: " + season.toUpperCase());
        System.out.println("String in Lowercase: " + season.toLowerCase());
    }
    ...
    private static void exercise3() {
        ...
        String textFrom2Primitives = "" + 1.5 + 67 + true; // <--- Edit this line
