...
public class Main {
    public static void main(String[] args) {
        Student mwanafunzi = new Student("Wairimu", "Njoroge", 234456, 3);
        Professor mwalimu = new Professor("Wesonga", "Shikunzu", 589302, "Literature");
        Assistant msaidizi = new Assistant("Mwala", "Makau", 478930, false);

        mwanafunzi.goToCollege();
        mwalimu.goToCollege();
        msaidizi.goToCollege();

        mwanafunzi.studyAtHome();
        mwalimu.teachToOtherPeople();
        msaidizi.teachToOtherPeople();
        msaidizi.studyAtHome();
